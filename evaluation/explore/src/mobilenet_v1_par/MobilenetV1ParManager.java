...
public class MobilenetV1ParManager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1ParManager(
  ...
  public static void main(String[] args) {
    MobilenetV1ParEngineParameters params = new MobilenetV1ParEngineParameters(args);
    ...
    MobilenetV1ParManager mgr = new MobilenetV1ParManager(params, cps);
