...
public class Resnet18OnnxB8S8Manager extends Max5LMemManager implements ManagerInterface {
  public Resnet18OnnxB8S8Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Resnet18OnnxB8S8EngineParameters params = new Resnet18OnnxB8S8EngineParameters(args);
    ...
    Resnet18OnnxB8S8Manager mgr = new Resnet18OnnxB8S8Manager(params, cps);
