...
public class MobilenetV1ParS4Manager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1ParS4Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    MobilenetV1ParS4EngineParameters params = new MobilenetV1ParS4EngineParameters(args);
    ...
    MobilenetV1ParS4Manager mgr = new MobilenetV1ParS4Manager(params, cps);
