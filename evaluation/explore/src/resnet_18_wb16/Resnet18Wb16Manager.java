...
public class Resnet18Wb16Manager extends Max5LMemManager implements ManagerInterface {
  public Resnet18Wb16Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Resnet18Wb16EngineParameters params = new Resnet18Wb16EngineParameters(args);
    ...
    Resnet18Wb16Manager mgr = new Resnet18Wb16Manager(params, cps);
