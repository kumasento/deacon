...
public class Resnet18OnnxManager extends Max5LMemManager implements ManagerInterface {
  public Resnet18OnnxManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Resnet18OnnxEngineParameters params = new Resnet18OnnxEngineParameters(args);
    ...
    Resnet18OnnxManager mgr = new Resnet18OnnxManager(params, cps);
