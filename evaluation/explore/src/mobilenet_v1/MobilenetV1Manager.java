...
public class MobilenetV1Manager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    MobilenetV1EngineParameters params = new MobilenetV1EngineParameters(args);
    ...
    MobilenetV1Manager mgr = new MobilenetV1Manager(params, cps);
