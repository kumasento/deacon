...
public class Resnet18OnnxB8S2Manager extends Max5LMemManager implements ManagerInterface {
  public Resnet18OnnxB8S2Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Resnet18OnnxB8S2EngineParameters params = new Resnet18OnnxB8S2EngineParameters(args);
    ...
    Resnet18OnnxB8S2Manager mgr = new Resnet18OnnxB8S2Manager(params, cps);
