...
public class MobilenetV1ParS8Manager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1ParS8Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    MobilenetV1ParS8EngineParameters params = new MobilenetV1ParS8EngineParameters(args);
    ...
    MobilenetV1ParS8Manager mgr = new MobilenetV1ParS8Manager(params, cps);
