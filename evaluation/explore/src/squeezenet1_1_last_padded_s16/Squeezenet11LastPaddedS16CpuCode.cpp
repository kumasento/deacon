...
struct Dfe {
  typedef Squeezenet11LastPaddedS16_actions_t dfe_run_actions_t;
  typedef Squeezenet11LastPaddedS16_dramRead_actions_t dram_read_actions_t;
  typedef Squeezenet11LastPaddedS16_dramWrite_actions_t dram_write_actions_t;

  static void ReadDRAM(max_engine_t *engine, dram_read_actions_t *actions) {
    Squeezenet11LastPaddedS16_dramRead_run(engine, actions);
  }
  static void WriteDRAM(max_engine_t *engine, dram_write_actions_t *actions) {
    Squeezenet11LastPaddedS16_dramWrite_run(engine, actions);
  }
};
...
int main(int argc, char *argv[]) {
  ...
  max_file_t *max_file = Squeezenet11LastPaddedS16_init();
  max_engine_t *engine = max_load(max_file, "*");

  std::vector<ConvLayerParameters> cps;
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv0fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0pool0fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv1fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv2fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv3fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat0"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv4fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv5fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv6fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat1"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0pool1fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv7fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv8fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv9fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat2"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv10fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv11fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv12fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat3"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0pool2fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv13fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv14fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv15fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat4"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv16fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv17fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv18fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat5"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv19fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv20fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv21fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat6"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv22fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv23fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv24fwd"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0concat7"));
  cps.push_back(ConvLayerParameters(max_file, "squeezenet0conv25fwd"));
  ...
  /* Launch run */
  Squeezenet11LastPaddedS16_actions_t actions;
  ...
  for (int i = 0; i < (int)num_iters; i++)
    Squeezenet11LastPaddedS16_run(engine, &actions);
