...
public class Resnet18ParS2Manager extends Max5LMemManager implements ManagerInterface {
  public Resnet18ParS2Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Resnet18ParS2EngineParameters params = new Resnet18ParS2EngineParameters(args);
    ...
    Resnet18ParS2Manager mgr = new Resnet18ParS2Manager(params, cps);
