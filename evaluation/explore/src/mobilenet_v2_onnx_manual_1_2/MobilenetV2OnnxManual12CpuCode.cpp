...
struct Dfe {
  typedef MobilenetV2OnnxManual12_actions_t dfe_run_actions_t;
  typedef MobilenetV2OnnxManual12_dramRead_actions_t dram_read_actions_t;
  typedef MobilenetV2OnnxManual12_dramWrite_actions_t dram_write_actions_t;

  static void ReadDRAM(max_engine_t *engine, dram_read_actions_t *actions) {
    MobilenetV2OnnxManual12_dramRead_run(engine, actions);
  }
  static void WriteDRAM(max_engine_t *engine, dram_write_actions_t *actions) {
    MobilenetV2OnnxManual12_dramWrite_run(engine, actions);
  }
};
...
int main(int argc, char *argv[]) {
  ...
  max_file_t *max_file = MobilenetV2OnnxManual12_init();
  ...
  cps.push_back(ConvLayerParameters(max_file, "conv18"));
  cps.push_back(ConvLayerParameters(max_file, "conv21"));
  cps.push_back(ConvLayerParameters(max_file, "conv23"));
  cps.push_back(ConvLayerParameters(max_file, "conv27"));
  cps.push_back(ConvLayerParameters(max_file, "conv29"));
  cps.push_back(ConvLayerParameters(max_file, "conv33"));
  cps.push_back(ConvLayerParameters(max_file, "conv35"));
  cps.push_back(ConvLayerParameters(max_file, "conv38"));
  cps.push_back(ConvLayerParameters(max_file, "conv40"));
  cps.push_back(ConvLayerParameters(max_file, "conv44"));
  cps.push_back(ConvLayerParameters(max_file, "conv46"));
  cps.push_back(ConvLayerParameters(max_file, "conv50"));
  cps.push_back(ConvLayerParameters(max_file, "conv52"));
  cps.push_back(ConvLayerParameters(max_file, "conv56"));
  cps.push_back(ConvLayerParameters(max_file, "conv58"));
  cps.push_back(ConvLayerParameters(max_file, "conv61"));
  cps.push_back(ConvLayerParameters(max_file, "conv63"));
  cps.push_back(ConvLayerParameters(max_file, "conv67"));
  cps.push_back(ConvLayerParameters(max_file, "conv69"));
  cps.push_back(ConvLayerParameters(max_file, "conv73"));
  cps.push_back(ConvLayerParameters(max_file, "conv75"));
  cps.push_back(ConvLayerParameters(max_file, "conv78"));
  cps.push_back(ConvLayerParameters(max_file, "conv80"));
  cps.push_back(ConvLayerParameters(max_file, "conv84"));
  cps.push_back(ConvLayerParameters(max_file, "conv86"));
  cps.push_back(ConvLayerParameters(max_file, "conv90"));
  cps.push_back(ConvLayerParameters(max_file, "conv92"));
  cps.push_back(ConvLayerParameters(max_file, "conv95"));
  ...
  /* Launch run */
  MobilenetV2OnnxManual12_actions_t actions;
  ...
  for (int i = 0; i < (int)num_iters; i++)
    MobilenetV2OnnxManual12_run(engine, &actions);
