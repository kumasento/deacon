...
public class MobilenetV1IntrseqManual5KManager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1IntrseqManual5KManager(
  ...
  public static void main(String[] args) {
    MobilenetV1IntrseqManual5KEngineParameters params =
        new MobilenetV1IntrseqManual5KEngineParameters(args);
    ...
    MobilenetV1IntrseqManual5KManager mgr = new MobilenetV1IntrseqManual5KManager(params, cps);
