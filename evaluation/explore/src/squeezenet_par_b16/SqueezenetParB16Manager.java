...
public class SqueezenetParB16Manager extends Max5LMemManager implements ManagerInterface {
  public SqueezenetParB16Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SqueezenetParB16EngineParameters params = new SqueezenetParB16EngineParameters(args);
    ...
    SqueezenetParB16Manager mgr = new SqueezenetParB16Manager(params, cps);
