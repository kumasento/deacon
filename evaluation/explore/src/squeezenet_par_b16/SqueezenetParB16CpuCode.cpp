...
struct Dfe {
  typedef SqueezenetParB16_actions_t dfe_run_actions_t;
  typedef SqueezenetParB16_dramRead_actions_t dram_read_actions_t;
  typedef SqueezenetParB16_dramWrite_actions_t dram_write_actions_t;

  static void ReadDRAM(max_engine_t *engine, dram_read_actions_t *actions) {
    SqueezenetParB16_dramRead_run(engine, actions);
  }
  static void WriteDRAM(max_engine_t *engine, dram_write_actions_t *actions) {
    SqueezenetParB16_dramWrite_run(engine, actions);
  }
};
...
int main(int argc, char *argv[]) {
  ...
  max_file_t *max_file = SqueezenetParB16_init();
  ...
  cps.push_back(ConvLayerParameters(max_file, "fire0s"));
  cps.push_back(ConvLayerParameters(max_file, "fire0e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire0e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire0c"));
  cps.push_back(ConvLayerParameters(max_file, "fire1s"));
  cps.push_back(ConvLayerParameters(max_file, "fire1e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire1e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire1c"));
  cps.push_back(ConvLayerParameters(max_file, "pool1"));
  cps.push_back(ConvLayerParameters(max_file, "fire2s"));
  cps.push_back(ConvLayerParameters(max_file, "fire2e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire2e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire2c"));
  cps.push_back(ConvLayerParameters(max_file, "fire3s"));
  cps.push_back(ConvLayerParameters(max_file, "fire3e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire3e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire3c"));
  cps.push_back(ConvLayerParameters(max_file, "pool2"));
  cps.push_back(ConvLayerParameters(max_file, "fire4s"));
  cps.push_back(ConvLayerParameters(max_file, "fire4e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire4e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire4c"));
  cps.push_back(ConvLayerParameters(max_file, "fire5s"));
  cps.push_back(ConvLayerParameters(max_file, "fire5e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire5e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire5c"));
  cps.push_back(ConvLayerParameters(max_file, "fire6s"));
  cps.push_back(ConvLayerParameters(max_file, "fire6e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire6e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire6c"));
  cps.push_back(ConvLayerParameters(max_file, "fire7s"));
  cps.push_back(ConvLayerParameters(max_file, "fire7e0"));
  cps.push_back(ConvLayerParameters(max_file, "fire7e1"));
  cps.push_back(ConvLayerParameters(max_file, "fire7c"));
  ...
  /* Launch run */
  SqueezenetParB16_actions_t actions;
  ...
  for (int i = 0; i < (int)num_iters; i++)
    SqueezenetParB16_run(engine, &actions);
