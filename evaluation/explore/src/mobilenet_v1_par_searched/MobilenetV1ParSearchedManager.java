...
public class MobilenetV1ParSearchedManager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1ParSearchedManager(
  ...
  public static void main(String[] args) {
    MobilenetV1ParSearchedEngineParameters params =
        new MobilenetV1ParSearchedEngineParameters(args);
    ...
    MobilenetV1ParSearchedManager mgr = new MobilenetV1ParSearchedManager(params, cps);
