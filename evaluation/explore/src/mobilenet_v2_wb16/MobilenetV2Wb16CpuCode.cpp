...
struct Dfe {
  typedef MobilenetV2Wb16_actions_t dfe_run_actions_t;
  typedef MobilenetV2Wb16_dramRead_actions_t dram_read_actions_t;
  typedef MobilenetV2Wb16_dramWrite_actions_t dram_write_actions_t;

  static void ReadDRAM(max_engine_t *engine, dram_read_actions_t *actions) {
    MobilenetV2Wb16_dramRead_run(engine, actions);
  }
  static void WriteDRAM(max_engine_t *engine, dram_write_actions_t *actions) {
    MobilenetV2Wb16_dramWrite_run(engine, actions);
  }
};
...
int main(int argc, char *argv[]) {
  ...
  max_file_t *max_file = MobilenetV2Wb16_init();
  max_engine_t *engine = max_load(max_file, "*");

  std::vector<ConvLayerParameters> cps;
  cps.push_back(ConvLayerParameters(max_file, "conv0"));
  cps.push_back(ConvLayerParameters(max_file, "b0c0"));
  cps.push_back(ConvLayerParameters(max_file, "b0c1"));
  cps.push_back(ConvLayerParameters(max_file, "b1c0"));
  cps.push_back(ConvLayerParameters(max_file, "b1c1"));
  cps.push_back(ConvLayerParameters(max_file, "b2c0"));
  cps.push_back(ConvLayerParameters(max_file, "b2c1"));
  cps.push_back(ConvLayerParameters(max_file, "b3c0"));
  cps.push_back(ConvLayerParameters(max_file, "b3c1"));
  cps.push_back(ConvLayerParameters(max_file, "b4c0"));
  cps.push_back(ConvLayerParameters(max_file, "b4c1"));
  cps.push_back(ConvLayerParameters(max_file, "b5c0"));
  cps.push_back(ConvLayerParameters(max_file, "b5c1"));
  cps.push_back(ConvLayerParameters(max_file, "b6c0"));
  cps.push_back(ConvLayerParameters(max_file, "b6c1"));
  cps.push_back(ConvLayerParameters(max_file, "b7c0"));
  cps.push_back(ConvLayerParameters(max_file, "b7c1"));
  cps.push_back(ConvLayerParameters(max_file, "b8c0"));
  cps.push_back(ConvLayerParameters(max_file, "b8c1"));
  cps.push_back(ConvLayerParameters(max_file, "b9c0"));
  cps.push_back(ConvLayerParameters(max_file, "b9c1"));
  cps.push_back(ConvLayerParameters(max_file, "b10c0"));
  cps.push_back(ConvLayerParameters(max_file, "b10c1"));
  cps.push_back(ConvLayerParameters(max_file, "b11c0"));
  cps.push_back(ConvLayerParameters(max_file, "b11c1"));
  cps.push_back(ConvLayerParameters(max_file, "b12c0"));
  cps.push_back(ConvLayerParameters(max_file, "b12c1"));
  cps.push_back(ConvLayerParameters(max_file, "b13c0"));
  cps.push_back(ConvLayerParameters(max_file, "b13c1"));
  cps.push_back(ConvLayerParameters(max_file, "b14c0"));
  cps.push_back(ConvLayerParameters(max_file, "b14c1"));
  cps.push_back(ConvLayerParameters(max_file, "b15c0"));
  cps.push_back(ConvLayerParameters(max_file, "b15c1"));
  cps.push_back(ConvLayerParameters(max_file, "b16c0"));
  cps.push_back(ConvLayerParameters(max_file, "b16c1"));
  cps.push_back(ConvLayerParameters(max_file, "convlast"));
  ...
  /* Launch run */
  MobilenetV2Wb16_actions_t actions;
  ...
  for (int i = 0; i < (int)num_iters; i++)
    MobilenetV2Wb16_run(engine, &actions);
