...
public class MobilenetV1SearchedManager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1SearchedManager(
  ...
  public static void main(String[] args) {
    MobilenetV1SearchedEngineParameters params = new MobilenetV1SearchedEngineParameters(args);
    ...
    MobilenetV1SearchedManager mgr = new MobilenetV1SearchedManager(params, cps);
