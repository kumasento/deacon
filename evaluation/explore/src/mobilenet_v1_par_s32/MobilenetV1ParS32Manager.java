...
public class MobilenetV1ParS32Manager extends Max5LMemManager implements ManagerInterface {
  public MobilenetV1ParS32Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    MobilenetV1ParS32EngineParameters params = new MobilenetV1ParS32EngineParameters(args);
    ...
    MobilenetV1ParS32Manager mgr = new MobilenetV1ParS32Manager(params, cps);
