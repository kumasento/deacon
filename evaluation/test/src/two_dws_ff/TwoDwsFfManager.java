...
public class TwoDwsFfManager extends Max5LMemManager implements ManagerInterface {
  public TwoDwsFfManager(
  ...
  public static void main(String[] args) {
    TwoDwsFfEngineParameters params = new TwoDwsFfEngineParameters(args);
    ...
    TwoDwsFfManager mgr = new TwoDwsFfManager(params, cps);
