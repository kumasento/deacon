...
public class TwoConvManager extends Max5LMemManager implements ManagerInterface {
  public TwoConvManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    TwoConvEngineParameters params = new TwoConvEngineParameters(args);
    ...
    cps.add(new ConvLayerParameters.Builder(32, 32, 8, 4, 3)
                .BW(16)
                .WBW(16)
                .numFracBits(8)
                .type(Type.STANDARD)
