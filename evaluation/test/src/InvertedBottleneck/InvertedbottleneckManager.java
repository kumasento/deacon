...
public class InvertedbottleneckManager extends Max5LMemManager implements ManagerInterface {
  public InvertedbottleneckManager(
  ...
  public static void main(String[] args) {
    InvertedbottleneckEngineParameters params = new InvertedbottleneckEngineParameters(args);

    List<ConvLayerParameters> cps = new ArrayList<ConvLayerParameters>();

    cps.add(new ConvLayerParameters.Builder(32, 32, 2, 4, 1)
                .BW(16)
                .WBW(16)
                .numFracBits(0)
                .type(Type.STANDARD)
    ...
    cps.add(new ConvLayerParameters.Builder(32, 32, 4, 2, 3)
                .BW(16)
                .WBW(16)
                .numFracBits(0)
