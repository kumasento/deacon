...
public class TwoConvCfParLastManager extends Max5LMemManager implements ManagerInterface {
  public TwoConvCfParLastManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    TwoConvCfParLastEngineParameters params = new TwoConvCfParLastEngineParameters(args);
    ...
    TwoConvCfParLastManager mgr = new TwoConvCfParLastManager(params, cps);
