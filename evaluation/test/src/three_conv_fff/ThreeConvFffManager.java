...
public class ThreeConvFffManager extends Max5LMemManager implements ManagerInterface {
  public ThreeConvFffManager(
  ...
  public static void main(String[] args) {
    ThreeConvFffEngineParameters params = new ThreeConvFffEngineParameters(args);
    ...
    ThreeConvFffManager mgr = new ThreeConvFffManager(params, cps);
