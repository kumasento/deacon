...
public class ThreeConvFcfManager extends Max5LMemManager implements ManagerInterface {
  public ThreeConvFcfManager(
  ...
  public static void main(String[] args) {
    ThreeConvFcfEngineParameters params = new ThreeConvFcfEngineParameters(args);
    ...
    ThreeConvFcfManager mgr = new ThreeConvFcfManager(params, cps);
