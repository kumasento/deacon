...
public class Resnet
- 50 - AManager extends Max5LMemManager implements ManagerInterface {
  public Resnet - 50 - AManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Resnet - 50 - AEngineParameters params = new Resnet - 50 - AEngineParameters(args);
    ...
    Resnet - 50 - AManager mgr = new Resnet - 50 - AManager(params, cps);
