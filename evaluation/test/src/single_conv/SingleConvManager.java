...
public class SingleConvManager extends Max5LMemManager implements ManagerInterface {
  public SingleConvManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SingleConvEngineParameters params = new SingleConvEngineParameters(args);
