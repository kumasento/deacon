...
public class ConcatManager extends Max5LMemManager implements ManagerInterface {
  public ConcatManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    ConcatEngineParameters params = new ConcatEngineParameters(args);
    ...
    cps.add(new ConvLayerParameters.Builder(3, 3, 4, 2, 3)
                .BW(16)
                .WBW(16)
                .numFracBits(8)
                .type(Type.STANDARD)
    ...
    ConcatManager mgr = new ConcatManager(params, cps);
