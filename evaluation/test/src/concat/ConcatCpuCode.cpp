...
struct Dfe {
  typedef Concat_actions_t dfe_run_actions_t;
  typedef Concat_dramRead_actions_t dram_read_actions_t;
  typedef Concat_dramWrite_actions_t dram_write_actions_t;

  static void ReadDRAM(max_engine_t *engine, dram_read_actions_t *actions) {
    Concat_dramRead_run(engine, actions);
  }
  static void WriteDRAM(max_engine_t *engine, dram_write_actions_t *actions) {
    Concat_dramWrite_run(engine, actions);
  }
};
