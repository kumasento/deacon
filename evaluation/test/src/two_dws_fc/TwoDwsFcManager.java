...
public class TwoDwsFcManager extends Max5LMemManager implements ManagerInterface {
  public TwoDwsFcManager(
  ...
  public static void main(String[] args) {
    TwoDwsFcEngineParameters params = new TwoDwsFcEngineParameters(args);
    ...
    TwoDwsFcManager mgr = new TwoDwsFcManager(params, cps);
