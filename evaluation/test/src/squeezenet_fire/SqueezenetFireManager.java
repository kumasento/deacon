...
public class SqueezenetFireManager extends Max5LMemManager implements ManagerInterface {
  public SqueezenetFireManager(
  ...
  public static void main(String[] args) {
    SqueezenetFireEngineParameters params = new SqueezenetFireEngineParameters(args);
    ...
    SqueezenetFireManager mgr = new SqueezenetFireManager(params, cps);
