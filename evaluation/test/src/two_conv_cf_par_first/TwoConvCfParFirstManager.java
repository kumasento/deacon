...
public class TwoConvCfParFirstManager extends Max5LMemManager implements ManagerInterface {
  public TwoConvCfParFirstManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    TwoConvCfParFirstEngineParameters params = new TwoConvCfParFirstEngineParameters(args);

    List<ConvLayerParameters> cps = new ArrayList<ConvLayerParameters>();

    cps.add(new ConvLayerParameters.Builder(32, 32, 2, 2, 3)
                .BW(16)
                .WBW(16)
                .numFracBits(8)
                .type(Type.STANDARD)
    ...
    cps.add(new ConvLayerParameters.Builder(32, 32, 2, 4, 3)
                .BW(16)
                .WBW(16)
                .numFracBits(8)
                .type(Type.STANDARD)
    ...
    TwoConvCfParFirstManager mgr = new TwoConvCfParFirstManager(params, cps);
