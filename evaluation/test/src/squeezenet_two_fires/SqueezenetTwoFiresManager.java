...
public class SqueezenetTwoFiresManager extends Max5LMemManager implements ManagerInterface {
  public SqueezenetTwoFiresManager(
  ...
  public static void main(String[] args) {
    SqueezenetTwoFiresEngineParameters params = new SqueezenetTwoFiresEngineParameters(args);
    ...
    SqueezenetTwoFiresManager mgr = new SqueezenetTwoFiresManager(params, cps);
