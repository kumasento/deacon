...
public class Resnet18FstIdManager extends Max5LMemManager implements ManagerInterface {
  public Resnet18FstIdManager(
  ...
  public static void main(String[] args) {
    Resnet18FstIdEngineParameters params = new Resnet18FstIdEngineParameters(args);
    ...
    Resnet18FstIdManager mgr = new Resnet18FstIdManager(params, cps);
