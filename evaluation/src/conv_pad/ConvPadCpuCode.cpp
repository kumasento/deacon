...
struct Dfe {
  typedef ConvPad_actions_t dfe_run_actions_t;
  typedef ConvPad_dramRead_actions_t dram_read_actions_t;
  typedef ConvPad_dramWrite_actions_t dram_write_actions_t;

  static void ReadDRAM(max_engine_t *engine, dram_read_actions_t *actions) {
    ConvPad_dramRead_run(engine, actions);
  }
  static void WriteDRAM(max_engine_t *engine, dram_write_actions_t *actions) {
    ConvPad_dramWrite_run(engine, actions);
  }
};
...
int main(int argc, char *argv[]) {
  ...
  max_file_t *max_file = ConvPad_init();
