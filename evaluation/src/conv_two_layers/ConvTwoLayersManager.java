 ...
 */
public
class ConvTwoLayersManager extends Max5LMemManager implements ManagerInterface {
 public
  ConvTwoLayersManager(ConvTwoLayersEngineParameters params,
 ...
 public
  EngineInterface interfaceDefault(List<ConvLayerParameters> cps,
  ...
  @SuppressWarnings("deprecation") public static void main(String[] args) {
    ...
    CompSeq seq1 = (seq0 == CompSeq.CHANNEL_MAJOR) ? CompSeq.FILTER_MAJOR
