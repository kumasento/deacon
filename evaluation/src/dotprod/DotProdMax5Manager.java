...
public
final class DotProdMax5Manager extends MAX5CManager {
 private
 ...
 public
  DotProdMax5Manager(DotProdEngineParameters params) {
    super(params);
 ...
 public
  static void main(String[] args) {
    ...
    DotProdMax5Manager mgr = new DotProdMax5Manager(params);
