...
- ParManager extends Max5LMemManager implements ManagerInterface {
  public Squeezenet - ParManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    Squeezenet - ParEngineParameters params = new Squeezenet - ParEngineParameters(args);
    ...
    Squeezenet - ParManager mgr = new Squeezenet - ParManager(params, cps);
