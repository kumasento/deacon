...
public class SqueezenetParManager extends Max5LMemManager implements ManagerInterface {
  public SqueezenetParManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SqueezenetParEngineParameters params = new SqueezenetParEngineParameters(args);
    ...
    SqueezenetParManager mgr = new SqueezenetParManager(params, cps);
