...
public class BottleneckShortcutImbalancedManager
    extends Max5LMemManager implements ManagerInterface {
  public BottleneckShortcutImbalancedManager(
  ...
  public static void main(String[] args) {
    BottleneckShortcutImbalancedEngineParameters params =
        new BottleneckShortcutImbalancedEngineParameters(args);
