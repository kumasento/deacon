...
public class SinglePwS2Manager extends Max5LMemManager implements ManagerInterface {
  public SinglePwS2Manager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SinglePwS2EngineParameters params = new SinglePwS2EngineParameters(args);

    List<ConvLayerParameters> cps = new ArrayList<ConvLayerParameters>();

    cps.add(new ConvLayerParameters.Builder(2, 2, 2, 2, 1)
                .input("")
                .BW(16)
                .WBW(16)
                .numFracBits(0)
    ...
    SinglePwS2Manager mgr = new SinglePwS2Manager(params, cps);
