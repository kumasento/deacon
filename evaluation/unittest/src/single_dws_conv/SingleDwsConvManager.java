...
public class SingleDwsConvManager extends Max5LMemManager implements ManagerInterface {
  public SingleDwsConvManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SingleDwsConvEngineParameters params = new SingleDwsConvEngineParameters(args);
    ...
    SingleDwsConvManager mgr = new SingleDwsConvManager(params, cps);
