...
public class SingleDwsConvNonDivisibleManager extends Max5LMemManager implements ManagerInterface {
  public SingleDwsConvNonDivisibleManager(
  ...
  public static void main(String[] args) {
    SingleDwsConvNonDivisibleEngineParameters params =
        new SingleDwsConvNonDivisibleEngineParameters(args);
    ...
    SingleDwsConvNonDivisibleManager mgr = new SingleDwsConvNonDivisibleManager(params, cps);
