...
public class SingleConvParManager extends Max5LMemManager implements ManagerInterface {
  public SingleConvParManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SingleConvParEngineParameters params = new SingleConvParEngineParameters(args);
    ...
    SingleConvParManager mgr = new SingleConvParManager(params, cps);
