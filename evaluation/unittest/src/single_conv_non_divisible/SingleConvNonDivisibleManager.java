package single_conv_non_divisible;
...
public class SingleConvNonDivisibleManager extends Max5LMemManager implements ManagerInterface {
  public SingleConvNonDivisibleManager(
  ...
  public static void main(String[] args) {
    SingleConvNonDivisibleEngineParameters params =
        new SingleConvNonDivisibleEngineParameters(args);

    List<ConvLayerParameters> cps = new ArrayList<ConvLayerParameters>();

    cps.add(new ConvLayerParameters.Builder(2, 2, 3, 3, 3)
                .input("")
                .BW(16)
                .WBW(16)
                .numFracBits(0)
    ...
    SingleConvNonDivisibleManager mgr = new SingleConvNonDivisibleManager(params, cps);
