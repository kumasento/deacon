...
public class BottleneckShortcutImbalancedParManager
    extends Max5LMemManager implements ManagerInterface {
  public BottleneckShortcutImbalancedParManager(
  ...
  public static void main(String[] args) {
    BottleneckShortcutImbalancedParEngineParameters params =
        new BottleneckShortcutImbalancedParEngineParameters(args);
    ...
    BottleneckShortcutImbalancedParManager mgr =
        new BottleneckShortcutImbalancedParManager(params, cps);
