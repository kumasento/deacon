...
public class SingleDwsConvParManager extends Max5LMemManager implements ManagerInterface {
  public SingleDwsConvParManager(ConvLayerEngineParameters params, List<ConvLayerParameters> cps) {
    super(params);
  ...
  public static void main(String[] args) {
    SingleDwsConvParEngineParameters params = new SingleDwsConvParEngineParameters(args);
