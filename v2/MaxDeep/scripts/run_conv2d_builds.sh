...
run_conv2d_multi_pumped_builds() {
  ...
  run_conv2d_build 2  128 2 100 2
  run_conv2d_build 3  128 4 100 2
}

run_conv2d_large_builds() {
  run_conv2d_build 1  128 1 100 1 &
  run_conv2d_build 2  128 2 100 1 
  run_conv2d_build 1  128 1 150 1 
  run_conv2d_build 2  128 2 150 1 
}
...
run_conv2d_chnl_builds() {
  run_conv2d_build 1 1 1 100 1 &
  run_conv2d_build 2 1 2 100 1 &
  run_conv2d_build 1 2 1 100 1 &
  run_conv2d_build 2 2 2 100 1
  # run_conv2d_build 1 2 1 100 2
  # run_conv2d_build 2 2 1 100 2 
}
