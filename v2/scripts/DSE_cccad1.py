...
if __name__ == '__main__':
    ...
    processes = [
        ...
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 14, 1), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 14, 2), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 16, 1), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 16, 2), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 18, 1), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 18, 2), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 20, 1), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 20, 2), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 22, 1), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 22, 2), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 24, 1), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 24, 2), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 26, 1), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 26, 2), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 28, 1), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 28, 2), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 30, 1), )),
        # mp.Process(target=build, args=(MaxDeepBuildParam(100, 30, 2), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 32, 1), )),
        mp.Process(target=build, args=(MaxDeepBuildParam(100, 32, 2), )),
    ]
